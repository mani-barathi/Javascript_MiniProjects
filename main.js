...
const links = [
	...
	{ id:12, name: "Password Generator", url: "./Password_Generator/index.html"},
	{ id:13, name: "Pomodoro Timer", url: "./Pomodoro_Timer/index.html"}, 
	{ id:14, name: "Quote generator", url: "./Quote_generator/index.html"},
	{ id:15, name: "Rock Paper Scissors", url: "./Rock_Paper_Scissors/index.html"},
	{ id:16, name: "Sorting Visualizer", url: "./Sorting_Visualizer/index.html"},
	{ id:17, name: "Text Editor", url: "./Text_Editor/index.html"},
	{ id:18, name: "TicTacToe", url: "./TicTacToe/index.html"},
	{ id:19, name: "TodoList", url: "./TodoList/index.html"},
	{ id:20, name: "Weather App", url: "./Weather_App/index.html"},
]
