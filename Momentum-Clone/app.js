...
const API_KEY = "hz3G1Q9pZpkHx1op4AbSarA5Z32hR7cTV_UeNuuDn4U";
...
function runClock() {
  ...
  if (hours >= 5 && hours < 12) greetingText.textContent = "Good morning, ";
...
async function getWallpaper() {
  ...
  let country = response[0].location.country
    ? response[0].location.country
    : "";
