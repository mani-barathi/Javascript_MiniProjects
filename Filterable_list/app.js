const names = [
    'Annabell Helper', 'Laure Cheng', 'Bev Dudding', 'Clinton Hampshire',
    'Millard Soderman', 'Palmira Hotz', 'Fredric Ulloa', 'Renetta Steffes',
    'Martha Bachelder', 'Alene Burchard', 'Augustus Glatz', 'Youlanda Cardona',
    'Garnett Brignac', 'Buffy Vedder', 'Mary Storms', 'Ervin Salsman',
    'Marielle Rambin', 'Rueben Cothren', 'Monnie Whipple', 'Jayson Sullivan',
]
...
function renderNames(nameList, searchValue = '') {
    ...
    for (let name of nameList) {
        ...
        if (searchValue) {
            ...
            let markedName = ''
            console.log(`'${searchValue}' is in '${name}' at (${startIndex}, ${endIndex}) `)
