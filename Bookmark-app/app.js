...
function renderBookmark(bookmarkName, bookmarkLink) {
    ...
    const divMainContainer = createCustomElement('div', ['item__mainContainer', 'align-items-center', 'd-flex']);
...
function fetchBookmarks() {
    ...
    if (temp)
        ...
        bookmarks = [{ name: "Mani 's GitHub", link: "https://github.com/mani-barathi" }];
}
